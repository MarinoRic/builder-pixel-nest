    ...
    <div class="section-container py-8">
      ...
      <div v-if="activeSection === 'overview'">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
          <div class="bg-barbershop-secondary border border-barbershop-border rounded-xl p-6">
            <div class="flex items-center justify-between">
              ...
              <div
                class="w-12 h-12 bg-barbershop-gold/20 rounded-lg flex items-center justify-center"
              >
                <svg
          ...
          <div class="bg-barbershop-secondary border border-barbershop-border rounded-xl p-6">
            <div class="flex items-center justify-between">
              <div>
                ...
                <p class="text-2xl font-bold text-barbershop-gold">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-8">
          ...
          <div class="bg-barbershop-secondary border border-barbershop-border rounded-xl p-6">
            ...
            <div class="h-64 flex items-end justify-between space-x-2">
              <div
                ...
                :style="{
                  height: `${(day.amount / Math.max(...weeklyRevenue.map((d) => d.amount))) * 100}%`,
                }"
              >
                <div class="h-full flex flex-col justify-end p-2">
                  <div class="text-xs text-barbershop-text text-center">€{{ day.amount }}</div>
                  <div class="text-xs text-barbershop-text-muted text-center mt-1">
                    {{ day.day }}
                  </div>
                </div>
              </div>
          ...
          <!-- Appointments Chart -->
          <div class="bg-barbershop-secondary border border-barbershop-border rounded-xl p-6">
            <h3 class="text-lg font-semibold text-barbershop-text mb-4">
                ...
                <div class="flex items-center space-x-3">
                  <div class="w-24 bg-barbershop-accent rounded-full h-2">
                    <div
                      ...
                      :style="{
                        width: `${(service.count / Math.max(...serviceStats.map((s) => s.count))) * 100}%`,
                      }"
                    ></div>
                  </div>
