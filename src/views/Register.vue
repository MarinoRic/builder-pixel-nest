<template>
  <div class="min-h-screen flex items-center justify-center bg-barbershop-primary py-12 px-4 sm:px-6 lg:px-8">
    <div class="max-w-md w-full space-y-8">
      <div class="text-center">
        ...
        <p class="text-barbershop-text-muted">
          Unisciti alla famiglia BarberShop
        </p>
      </div>
      ...
      <form @submit.prevent="handleRegister" class="mt-8 space-y-6">
        <div class="space-y-4">
          <!-- Nome -->
          <div>
            <label for="nome" class="block text-sm font-medium text-barbershop-text mb-2">
              Nome *
            </label>
            <input
              id="nome"
          ...
          <!-- Cognome -->
          <div>
            <label for="cognome" class="block text-sm font-medium text-barbershop-text mb-2">
              Cognome *
            </label>
            <input
              id="cognome"
          ...
          <!-- Telefono -->
          <div>
            <label for="telefono" class="block text-sm font-medium text-barbershop-text mb-2">
              Numero di Telefono *
            </label>
            <input
              id="telefono"
          ...
          <div>
            ...
            <p class="mt-1 text-xs text-barbershop-text-muted">
              Minimo 6 caratteri
            </p>
          </div>
          ...
          <!-- Confirm Password -->
          <div>
            <label for="confirmPassword" class="block text-sm font-medium text-barbershop-text mb-2">
              Conferma Password *
            </label>
            <div class="relative">
              <input
            ...
            <p v-if="passwordMismatch" class="mt-1 text-xs text-red-400">
        ...
        <!-- Error Message -->
        <div v-if="authStore.error" class="text-red-400 text-sm text-center bg-red-400/10 border border-red-400/20 rounded-lg p-3">
          {{ authStore.error }}
        </div>
        ...
        <div class="flex items-start">
          ...
          <div class="ml-3 text-sm">
            <label for="terms" class="text-barbershop-text-muted">
              Accetto i
              <a href="#" class="text-barbershop-gold hover:text-barbershop-gold-light transition-colors duration-200">
                Termini di Servizio
              </a>
              e la
              <a href="#" class="text-barbershop-gold hover:text-barbershop-gold-light transition-colors duration-200">
        ...
        <div>
          ...
          >
            <span v-if="!authStore.loading">Crea Account</span>
        ...
        <div class="text-center">
          <p class="text-barbershop-text-muted">
            Hai già un account?
            <router-link to="/login" class="text-barbershop-gold hover:text-barbershop-gold-light transition-colors duration-200 font-medium">
              Accedi qui
            </router-link>
          </p>
        </div>
      ...
      <!-- Back to Home -->
      <div class="text-center">
        <router-link to="/" class="inline-flex items-center text-barbershop-text-muted hover:text-barbershop-gold transition-colors duration-200">
