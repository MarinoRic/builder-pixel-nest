          ...
          <div class="flex flex-col md:flex-row md:items-center md:justify-between space-y-3 md:space-y-0">
            <div class="flex items-center space-x-4">
              <div class="text-center">
                ...
                <div class="text-xs text-barbershop-text-muted">{{ formatDate(appointment.date) }}</div>
              </div>
              <div>
                ...
                <div class="flex items-center space-x-4 mt-1">
                  <span class="text-xs text-barbershop-text-muted">{{ appointment.clientEmail }}</span>
                  <span class="text-xs text-barbershop-text-muted">{{ appointment.clientPhone }}</span>
                </div>
              </div>
            </div>
...
const getFilterTitle = () => {
  switch (activeFilter.value) {
    case 'today': return 'Prenotazioni di Oggi'
    case 'upcoming': return 'Prenotazioni Future'
    case 'past': return 'Prenotazioni Passate'
    default: return 'Prenotazioni'
  }
}
