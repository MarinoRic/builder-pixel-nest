...
const slides = ref<Slide[]>([
  {
    ...
    description: 'Scopri l\'arte del taglio perfetto nel nostro salone, dove tradizione e modernità si incontrano per creare il tuo look ideale.',
  ...
  },
  {
    ...
    description: 'I nostri barbieri esperti combinano tecniche tradizionali con le ultime tendenze per garantirti sempre il massimo della qualità.',
  ...
  },
  {
    ...
    description: 'Rilassati nel nostro ambiente elegante e goditi un momento di puro benessere dedicato alla cura del tuo aspetto.',
